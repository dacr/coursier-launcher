...
test-ammonite: volume
	docker run -it --rm -v artifacts:/coursier-cache ${CONTAINER_NAME} launch com.lihaoyi:ammonite_2.13.3:2.3.8 -M ammonite.Main
...
test-primes: volume
	docker run -it --rm -v artifacts:/coursier-cache -p 8080:8080 -e PRIMES_MAX_COUNT=42 ${CONTAINER_NAME} launch fr.janalyse::primes-server-akkahttp:1.0.2
